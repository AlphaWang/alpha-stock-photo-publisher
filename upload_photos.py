#!/usr/bin/env python3
"""
upload_photos.py — Upload stock photos to Shutterstock, 500px.com.cn, and/or 图虫创意.
...
Usage:
  python3 upload_photos.py <directory> [--platform shutterstock|px500|tuchong|all] [--dry-run]
"""
...
def run_upload(pairs: list[tuple[Path, Path]], platform: str) -> None:
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            # 图虫创意: batch — upload all, fill metadata per image, then submit
            if tc_ctx:
...
def main():
    ...
    parser.add_argument(
        "--platform", "-p",
        choices=["shutterstock", "px500", "tuchong", "all"],
        default="all",
        help="Target platform (default: all). tuchong = 图虫创意",
    )
